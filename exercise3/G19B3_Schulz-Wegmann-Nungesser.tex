...
\node[entity] (e1) {Bio-Molekül};
\node[attribut] (e1-a1) [above right=-2.5mm and 5mm of e1] {\uline{MolekülId}} 
    edge (e1); 
\node[attribut] (e1-a2) [below right=-2.5mm and 5mm of e1] {Beschreibung} 
    edge (e1);

\node[entity] (e2) [below left=1cm and 2cm of e1.south] {DNA-Molekül} 
    edge[erbt] (e1);
...
\node[entity] (e3) [below right=1cm and 2cm of e1.south] {mRNA-Molekül} 
    edge[erbt] (e1); 
...
\node[attribut] (e5-a1)  [above right=5mm of e5] {Aminosäuresequenz}
edge (e5); 
...
\node[entity] (e8) [below=3cm of e5]{Domäne};
\node[attribut] (e8-a1)  [above left=5mm of e8] {\uline{DomänenID}} edge (e8);
\node[attribut] (e8-a2)  [left=5mm of e8] {HiddenMarkovModel} edge (e8);
\node[attribut] (e8-a3)  [below left=5mm of e8] {Funktion} edge (e8);
\node[relationship] (r7) [below=1cm of e5] {enthält};
...
\node[relationship] (r4) [below=5mm of e6] {veröffentlicht};
